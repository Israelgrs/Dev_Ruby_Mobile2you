...
class AwardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post awards_url, params: { award: { award_name: @award.award_name, event_id: @award.event_id, user_id: @award.user_id } }
    end
  ...
  test "should update award" do
    patch award_url(@award), params: { award: { award_name: @award.award_name, event_id: @award.event_id, user_id: @award.user_id } }
