...
class InscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inscription" do
    assert_difference('Inscription.count') do
      post inscriptions_url, params: { inscription: { event_id: @inscription.event_id, inscription_date: @inscription.inscription_date, user_id: @inscription.user_id } }
    end
  ...
  test "should update inscription" do
    patch inscription_url(@inscription), params: { inscription: { event_id: @inscription.event_id, inscription_date: @inscription.inscription_date, user_id: @inscription.user_id } }
