...
class EventsParticipationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create events_participation" do
    assert_difference('EventsParticipation.count') do
      post events_participations_url, params: { events_participation: { event_id: @events_participation.event_id, user_id: @events_participation.user_id, was_present: @events_participation.was_present } }
    end
  ...
  test "should update events_participation" do
    patch events_participation_url(@events_participation), params: { events_participation: { event_id: @events_participation.event_id, user_id: @events_participation.user_id, was_present: @events_participation.was_present } }
